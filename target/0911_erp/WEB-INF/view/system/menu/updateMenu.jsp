			...
			<div class="layui-inline">
				...
				<input type="hidden" name="id" value="${menu.id}">
					<input type="text" name="ordernum" id="ordernum" lay-verify="number"
						autocomplete="off" placeholder="排序码"  class="layui-input" value="${menu.ordernum }">
				</div>
			</div>
		</div>
		<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="name" id="name" lay-verify="required" autocomplete="off"
						placeholder="请输入菜单名称" class="layui-input" value="${menu.name }">
				</div>
			</div>
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="href" id="href" lay-verify="required" autocomplete="off"
						placeholder="请输入菜单地址" class="layui-input" value="${menu.href }">
				</div>
			</div>
		<div class="layui-form-item">
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<input type="text" name="icon" id="icon" lay-verify="required"
						autocomplete="off" placeholder="请输入菜单图标"  class="layui-input" value="${menu.icon }">
				</div>
			</div>
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<input type="text" name="target" id="target" 
						autocomplete="off" placeholder="TARGET" class="layui-input" value="${menu.target }">
				</div>
			</div>
			</div>
		<div class="layui-form-item">
