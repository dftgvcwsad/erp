 ...
 * Generated at: 2018-09-17 10:59:35 UTC
...
public final class outportRight_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t<title>退货列表---仓库管理系统 2.0</title>\r\n");
      ...
      out.write("\t<script type=\"text/html\"  id=\"outportToolBar\">\r\n");
      ...
      out.write("        url : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/outport/queryAllOutport.action',\r\n");
      out.write("        cellMinWidth : 95,\r\n");
      out.write("        page : true,\r\n");
      out.write("        toolbar: '#outportToolBar',\r\n");
      out.write("        defaultToolbar: ['filter', 'exports'],\r\n");
      out.write("        height : \"full-125\",\r\n");
      out.write("        limit : 10,\r\n");
      out.write("        limits : [10,15,20,25],\r\n");
      out.write("        id : \"outportListTable\",\r\n");
      out.write("        cols : [[\r\n");
      out.write("            {type: \"checkbox\", fixed:\"left\", width:50},\r\n");
      out.write("            {field: 'id', title: '退货ID', width:80, align:\"center\"},\r\n");
      out.write("            {field: 'goodsname', title: '商品名称',align:'center'},\r\n");
      out.write("            {field: 'providername', title: '供应商名称',align:'center'},\r\n");
      out.write("            {field: 'size', title: '商品规格', align:'center'},\r\n");
      out.write("            {field: 'outporttime', title: '退货时间', align:'center'},\r\n");
      out.write("            {field: 'number', title: '退货数量', align:'center'},\r\n");
      out.write("            {field: 'paytype', title: '支付方式', align:'center'},\r\n");
      out.write("            {field: 'remark', title: '注释', align:'center'},\r\n");
      out.write("            {field: 'operateperson', title: '操作员', align:'center'},\r\n");
      out.write("            {title: '操作', width:130, templet:'#outportListBar' ,fixed:\"right\",align:\"center\"}\r\n");
      out.write("        ]]\r\n");
      out.write("    });\r\n");
      out.write("    //监听头工具栏事件\r\n");
      ...
      out.write("                  outportId.push(data[i].id);\r\n");
      out.write("              }\r\n");
      out.write("              layer.confirm('确定删除选中的退货单？', {icon: 3, title: '提示信息'}, function (index) {\r\n");
      out.write("              \t //将需要删除的outportId作为json参数传入 \r\n");
      out.write("                  $.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/outport/batchDeleteOutport.action\",{outportIds : JSON.stringify(outportId) },function(data){\r\n");
      ...
      out.write("            content : \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/outport/toAddOutport.action\",\r\n");
      out.write("            success : function(layero, index){\r\n");
      out.write("                var body = layui.layer.getChildFrame('body', index);\r\n");
      out.write("                setTimeout(function(){\r\n");
      out.write("                    layui.layer.tips('点击此处返回退货列表', '.layui-layer-setwin .layui-layer-close', {\r\n");
      out.write("                        tips: 3\r\n");
      out.write("                    });\r\n");
      out.write("                },500)\r\n");
      out.write("            }\r\n");
      ...
      out.write("            content : \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/outport/toUpdateOutport.action?id=\"+id,\r\n");
      out.write("            success : function(layero, index){\r\n");
      out.write("                var body = layui.layer.getChildFrame('body', index);\r\n");
      out.write("                \r\n");
      out.write("                setTimeout(function(){\r\n");
      ...
      out.write("            layer.confirm('确定删除'+data.id+'编号'+data.goodsname+'商品的退货单？',{icon:3, title:'提示信息'},function(index){\r\n");
      out.write("                 $.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/outport/deleteOutport.action\",{\r\n");
      out.write("                \t id : data.id  //将需要删除的outportId作为参数传入\r\n");
      ...
      out.write("            layer.alert(\"此功能需要前台展示，实际开发中传入对应的必要参数进行退货内容页面访问\")\r\n");
      out.write("        }\r\n");
      out.write("    });\r\n");
      out.write("})\r\n");
      out.write("</script>\r\n");
