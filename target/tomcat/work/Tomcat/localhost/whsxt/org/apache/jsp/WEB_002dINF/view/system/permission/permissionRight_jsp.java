 ...
 * Generated at: 2018-09-14 06:46:58 UTC
...
public final class permissionRight_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t<title>权限列表---仓库管理系统 2.0</title>\r\n");
      ...
      out.write("\t<script type=\"text/html\"  id=\"permissionToolBar\">\r\n");
      ...
      out.write("        url : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/permission/queryAllPermission.action',\r\n");
      out.write("        cellMinWidth : 95,\r\n");
      out.write("        page : true,\r\n");
      out.write("        toolbar: '#permissionToolBar',\r\n");
      ...
      out.write("            {field: 'id', title: '权限ID', width:80, align:\"center\"},\r\n");
      out.write("            {field: 'pid', title: '父级ID', width:80, align:\"center\"},\r\n");
      out.write("            {field: 'name', title: '权限名称',align:'center'},\r\n");
      out.write("            {field: 'percode', title: '权限编码', align:'center'},\r\n");
      out.write("            {field: 'available', title: '是否可用', align:'center',templet:function(d){\r\n");
      out.write("                return d.open==1?\"可用\":\"不可用\";\r\n");
      out.write("            }},\r\n");
      out.write("            {field: 'ordernum', title: '排序码',align:'center'},\r\n");
      out.write("            {title: '操作', width:130, templet:'#permissionListBar' ,fixed:\"right\",align:\"center\"}\r\n");
      out.write("        ]]\r\n");
      out.write("    });\r\n");
      out.write("    //监听头工具栏事件\r\n");
      ...
      out.write("                  permissionId.push(data[i].id);\r\n");
      out.write("              }\r\n");
      out.write("              layer.confirm('确定删除选中的权限？', {icon: 3, title: '提示信息'}, function (index) {\r\n");
      out.write("              \t //将需要删除的permissionId作为json参数传入 \r\n");
      out.write("                  $.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/permission/batchDeletePermission.action\",{permissionIds : JSON.stringify(permissionId) },function(data){\r\n");
      ...
      out.write("            layer.confirm('确定删除'+data.id+'编号'+data.name+'权限？',{icon:3, title:'提示信息'},function(index){\r\n");
      out.write("                 $.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/permission/deletePermission.action\",{\r\n");
      out.write("                \t id : data.id  //将需要删除的permissionId作为参数传入\r\n");
      ...
      out.write("            layer.alert(\"此功能需要前台展示，实际开发中传入对应的必要参数进行权限内容页面访问\")\r\n");
      out.write("        }\r\n");
      out.write("    });\r\n");
      out.write("})\r\n");
      out.write("</script>\r\n");
