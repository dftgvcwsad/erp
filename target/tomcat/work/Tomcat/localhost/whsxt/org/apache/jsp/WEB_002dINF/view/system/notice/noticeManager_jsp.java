 ...
 * Generated at: 2018-09-15 11:49:12 UTC
...
public final class noticeManager_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t<title>公告列表---仓库管理系统 2.0</title>\r\n");
      ...
      out.write("\t\t\t\t\t\t<label class=\"layui-form-label\">标题 名称</label>\r\n");
      ...
      out.write("\t<script type=\"text/html\"  id=\"noticeToolBar\">\r\n");
      ...
      out.write("\t\t<a class=\"layui-btn layui-btn-xs layui-btn-warm\" lay-event=\"look\">详情</a>\r\n");
      out.write("\t</script>\r\n");
      out.write("</form>\r\n");
      ...
      out.write("        url : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/notice/queryAllNotice.action',\r\n");
      out.write("        cellMinWidth : 95,\r\n");
      out.write("        page : true,\r\n");
      out.write("        toolbar: '#noticeToolBar',\r\n");
      ...
      out.write("            {field: 'id', title: '公告ID', width:80, align:\"center\"},\r\n");
      out.write("            {field: 'title', title: '公告标题', width:200, align:\"center\"},\r\n");
      out.write("            {field: 'content', title: '详情',width:200,hide:true},\r\n");
      out.write("            {field: 'createtime', title: '发布时间', align:'center'},\r\n");
      out.write("            {field: 'opername', title: '操作员', align:'center'},\r\n");
      ...
      out.write("          } else {\r\n");
      out.write("        \t  //批量删除\r\n");
      out.write("              var  noticeId = [];\r\n");
      out.write("              for (var i in data) {\r\n");
      out.write("                  noticeId.push(data[i].id);\r\n");
      out.write("              }\r\n");
      out.write("              layer.confirm('确定删除选中的公告？', {icon: 3, title: '提示信息'}, function (index) {\r\n");
      out.write("            \t  //将需要删除的noticeId作为json参数传入 \r\n");
      out.write("                   $.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/notice/batchDeleteNotice.action\",{noticeIds:JSON.stringify(noticeId)},function(data){\r\n");
      ...
      out.write("            content : \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/notice/toUpdateNotice.action?id=\"+id,\r\n");
      out.write("            success : function(layero, index){\r\n");
      out.write("                var body = layui.layer.getChildFrame('body', index);\r\n");
      out.write("                \r\n");
      out.write("                setTimeout(function(){\r\n");
      ...
      out.write("                     id : data.id  //将需要删除的noticeId作为参数传入\r\n");
