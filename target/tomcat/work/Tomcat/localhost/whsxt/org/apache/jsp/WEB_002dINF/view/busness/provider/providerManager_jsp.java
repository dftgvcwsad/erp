 ...
 * Generated at: 2018-09-13 09:20:42 UTC
...
public final class providerManager_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t<title>供应商列表---仓库管理系统 2.0</title>\r\n");
      ...
      out.write("\t<script type=\"text/html\"  id=\"providerToolBar\">\r\n");
      ...
      out.write("        url : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/provider/queryAllProvider.action',\r\n");
      out.write("        cellMinWidth : 95,\r\n");
      out.write("        page : true,\r\n");
      out.write("        toolbar: '#providerToolBar',\r\n");
      ...
      out.write("            {field: 'id', title: '供应商ID', width:80, align:\"center\"},\r\n");
      out.write("            {field: 'providername', title: '供应商名称'},\r\n");
      out.write("            {field: 'zip', title: '供应商邮编', align:'center'},\r\n");
      out.write("            {field: 'address', title: '供应商地址', align:'center'},\r\n");
      out.write("            {field: 'telephone', title: '供应商电话', align:'center'},\r\n");
      ...
      out.write("            {field: 'fax', title: '供应商传真', align:'center'},\r\n");
      out.write("            {field: 'available ', title: '是否可用', align:'center', templet:function(d){\r\n");
      out.write("                return d.available==1?\"可用\":\"不可用\";\r\n");
      out.write("            }},\r\n");
      out.write("            {title: '操作', width:150, templet:'#providerListBar',fixed:\"right\",align:\"center\"}\r\n");
      out.write("        ]]\r\n");
      out.write("    });\r\n");
      out.write("   //监听头工具栏事件\r\n");
      ...
      out.write("                 providerId.push(data[i].id);\r\n");
      out.write("             }\r\n");
      out.write("             layer.confirm('确定删除选中的供应商？', {icon: 3, title: '提示信息'}, function (index) {\r\n");
      out.write("           \t  //将需要删除的providerId作为json参数传入 \r\n");
      out.write("                  $.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/provider/batchDeleteProvider.action\",{providerIds:JSON.stringify(providerId)},function(data){\r\n");
      ...
      out.write("           layer.confirm('确定删除'+data.providername+'供应商？',{icon:3, title:'提示信息'},function(index){\r\n");
      out.write("                $.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/provider/deleteProvider.action\",{\r\n");
      out.write("                    id : data.id  //将需要删除的providerId作为参数传入\r\n");
