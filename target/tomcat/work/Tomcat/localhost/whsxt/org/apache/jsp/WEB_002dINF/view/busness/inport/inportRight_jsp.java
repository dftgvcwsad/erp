 ...
 * Generated at: 2018-09-17 09:27:37 UTC
...
public final class inportRight_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t<title>进货列表---仓库管理系统 2.0</title>\r\n");
      ...
      out.write("\t<script type=\"text/html\"  id=\"inportToolBar\">\r\n");
      ...
      out.write("        url : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/inport/queryAllInport.action',\r\n");
      out.write("        cellMinWidth : 95,\r\n");
      out.write("        page : true,\r\n");
      out.write("        toolbar: '#inportToolBar',\r\n");
      ...
      out.write("            {field: 'id', title: '进货ID', width:80, align:\"center\"},\r\n");
      ...
      out.write("            {field: 'inporttime', title: '进货时间', align:'center'},\r\n");
      ...
      out.write("            {title: '操作', width:130, templet:'#inportListBar' ,fixed:\"right\",align:\"center\"}\r\n");
      out.write("        ]]\r\n");
      out.write("    });\r\n");
      out.write("    //监听头工具栏事件\r\n");
      ...
      out.write("                  inportId.push(data[i].id);\r\n");
      out.write("              }\r\n");
      out.write("              layer.confirm('确定删除选中的进货单？', {icon: 3, title: '提示信息'}, function (index) {\r\n");
      out.write("              \t //将需要删除的inportId作为json参数传入 \r\n");
      out.write("                  $.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/inport/batchDeleteInport.action\",{inportIds : JSON.stringify(inportId) },function(data){\r\n");
      ...
      out.write("                    layui.layer.tips('点击此处返回进货列表', '.layui-layer-setwin .layui-layer-close', {\r\n");
      out.write("                        tips: 3\r\n");
      out.write("                    });\r\n");
      out.write("                },500)\r\n");
      out.write("            }\r\n");
      ...
      out.write("            content : \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/inport/toUpdateInport.action?id=\"+id,\r\n");
      out.write("            success : function(layero, index){\r\n");
      out.write("                var body = layui.layer.getChildFrame('body', index);\r\n");
      out.write("                \r\n");
      out.write("                setTimeout(function(){\r\n");
      ...
      out.write("            layer.confirm('确定删除'+data.id+'编号'+data.goodsname+'商品的进货单？',{icon:3, title:'提示信息'},function(index){\r\n");
      out.write("                 $.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/inport/deleteInport.action\",{\r\n");
      out.write("                \t id : data.id  //将需要删除的inportId作为参数传入\r\n");
      ...
      out.write("            layer.alert(\"此功能需要前台展示，实际开发中传入对应的必要参数进行进货内容页面访问\")\r\n");
      out.write("        }\r\n");
      out.write("    });\r\n");
      out.write("})\r\n");
      out.write("</script>\r\n");
