 ...
 * Generated at: 2018-09-16 06:14:24 UTC
...
public final class userRight_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t<title>用户列表---仓库管理系统 2.0</title>\r\n");
      ...
      out.write("\t\t<a class=\"layui-btn layui-btn-xs layui-btn-normal\" lay-event=\"allocationRole\">分配角色</a>\r\n");
      out.write("\t</script>\r\n");
      out.write("</form>\r\n");
      ...
      out.write("            {field: 'id', title: '用户ID', width:80, align:\"center\"},\r\n");
      out.write("            {field: 'name', title: '用户名称',align:'center'},\r\n");
      out.write("            {field: 'deptname', title: '所在部门', align:'center'},\r\n");
      out.write("            {field: 'loginname', title: '登陆名称', align:'center'},\r\n");
      out.write("            {field: 'leadername', title: '直接领导', align:'center'},\r\n");
      out.write("            {field: 'address', title: '用户地址', align:'center'},\r\n");
      out.write("            {field: 'hiredate', title: '入职时间', align:'center'},\r\n");
      out.write("            {field: 'remark', title: '用户备注', align:'center'},\r\n");
      out.write("            {field: 'sex', title: '性别', align:'center',templet:function(d){\r\n");
      out.write("                return d.sex==1?\"男\":\"女\";\r\n");
      out.write("            }},\r\n");
      out.write("            {field: 'imgpath ', title: '用户头像', align:'center', templet:function(d){\r\n");
      out.write("                return \"<img width=20px height=20px alt=无效地址  src='\"+d.imgpath+\"'></img>\";\r\n");
      out.write("            }},\r\n");
      out.write("            {field: 'available ', title: '是否可用', align:'center', templet:function(d){\r\n");
      out.write("                return d.available==1?\"可用\":\"不可用\";\r\n");
      out.write("            }},\r\n");
      out.write("            {field: 'pwd', title: '密码', align:'center',templet:function(d){\r\n");
      out.write("                return \"*******\";\r\n");
      out.write("            }},\r\n");
      ...
      out.write("              \t //将需要删除的userId作为json参数传入 \r\n");
      out.write("                  $.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/user/batchDeleteUser.action\",{userIds : JSON.stringify(userId) },function(data){\r\n");
      ...
      out.write("            layer.confirm('确定删除'+data.id+'编号'+data.name+'用户？',{icon:3, title:'提示信息'},function(index){\r\n");
      out.write("                 $.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/user/deleteUser.action\",{\r\n");
      out.write("                \t id : data.id  //将需要删除的userId作为参数传入\r\n");
      out.write("               },function(data){\r\n");
      out.write("            \t   layer.msg(data.msg);\r\n");
      out.write("                    tableIns.reload();\r\n");
      out.write("                })\r\n");
      out.write("            });\r\n");
      out.write("        } else if(layEvent === 'resetPwd'){ //重置密码\r\n");
      out.write("        \t layer.confirm('确定重置'+data.id+'编号'+data.name+'用户的密码？',{icon:3, title:'提示信息'},function(index){\r\n");
      out.write("                 $.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/user/resetUserPwd.action\",{\r\n");
      ...
      out.write("                })\r\n");
      out.write("            });\r\n");
      out.write("        }else if (layEvent==='allocationRole') {\r\n");
      out.write("        \tallocationRole(data);\r\n");
      out.write("\t\t}\r\n");
      out.write("    });\r\n");
      out.write("    function allocationRole(user) {\r\n");
      out.write("    \tvar index = layui.layer.open({\r\n");
      out.write("            title : \"【\"+user.name+\"】用户分配角色页面\",\r\n");
      out.write("            //area设置弹出层大小\r\n");
      out.write("            area:[\"800px\",\"600px\"],\r\n");
      out.write("            type : 2,\r\n");
      out.write("            content : \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/user/toAllocationRole.action?id=\"+user.id,\r\n");
      out.write("            success : function(layero, index){\r\n");
      out.write("                var body = layui.layer.getChildFrame('body', index);\r\n");
      out.write("                setTimeout(function(){\r\n");
      out.write("                    layui.layer.tips('点击此处返回用户列表', '.layui-layer-setwin .layui-layer-close', {\r\n");
