	...
	<form id="layuiFm" class="layui-form" action="#" method="post" 
		...
		<div class="layui-form-item">
			<div class="layui-inline">
				...
				<input type="hidden" name="oldumber"   value="${outport.number }">
					<input type="text" name="number" id="number" lay-verify="number" value="${outport.number }"
		...
		<div class="layui-form-item layui-form-text">
				...
				<div class="layui-input-block">
					<textarea placeholder="请输入内容" name="remark"  id="remark"  class="layui-textarea">${outport.remark }</textarea>
				</div>
			</div>
					...
					form = layui.form;
							...
							form.on('submit(doUpdate)', function(data) {
								var params=$("#layuiFm").serialize();
							 	$.post("${ctx}/outport/updateOutport.action?"+params,function(obj){
